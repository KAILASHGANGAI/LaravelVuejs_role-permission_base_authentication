...
export default {
  ...
  created() {
    ...
    // }
    axios.get("/api/teacher/periods/create", {
      headers: {
    ...
    axios.get("/api/teacher/getclass/details" + this.id, {
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " +store.getters.getAdminToken,
      },
  ...
  methods: {
    ...
    getDatas() {
      axios.post('/api/teacher/get-students-subjects', this.form, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " +store.getters.getAdminToken,
        },
    ...
    saveMarks() {
      ...
      axios.post('/api/teacher/store-marks', this.marks, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " +store.getters.getAdminToken,
        },
