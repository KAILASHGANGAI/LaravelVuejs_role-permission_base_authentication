...
export default {
    ...
    created() {
        ...
        // }
        axios.get("/api/teacher/assignment", {
            headers: {
    ...
    methods: {
        ViewAssignment(index) {
            router.push('/teacher/view-assignment/' + index);

        },
        EditAssignment(index) {
            router.push('/teacher/edit-assignment/' + index);

        },
        DeleteAssignment(index) {
            axios.delete("/api/teacher/assignment/" + index, {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: "Bearer " + store.getters.getAdminToken,
                },
