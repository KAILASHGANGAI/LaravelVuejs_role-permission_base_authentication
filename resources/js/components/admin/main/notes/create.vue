                        ...
                        <form @submit="formSubmit" enctype="multipart/form-data">
                            <div class="d-flex">
                                <div class="form-group w-100">
                                    ...
                                    <select class="form-control w-100" name="course" id="course" v-model="faculty" required>
                                ...
                                <div class="form-group px-4 w-100">
                                    ...
                                    <br />
                                    <select class="form-control w-100" name="semester" id="semester" v-model="semester" required>
...
export default {
    ...
    methods: {
        ...
        formSubmit(e) {
            ...
            axios.post('/api/notes', data, config)
                .then(function (res) {
                    toast.fire({
                     
                      title: res.data.success
                  })
                    router.push('/admin/show-notes')
                })
                .catch(function (err) {
                   console.log(err)
                });
