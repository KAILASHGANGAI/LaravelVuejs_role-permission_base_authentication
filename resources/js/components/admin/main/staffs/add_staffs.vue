          ...
          <div class="card-body">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-4">
                ...
                <small v-if="errors.experience" class="text-danger">{{ errors.experience[0] }}</small>
              ...
              <div class="col-md-4">
                ...
                <select id="inputState" class="form-select" v-model="category">
                  <option selected="">Choose...</option>
                  <option v-for="catagory in categories" :key="catagory.id" :value="catagory.id">
              ...
              <div class="col-md-4">
                ...
                <img v-for="(eduImage, index) in eduImages" :key="index" :src="eduImage" alt="" srcset=""
                  height="100px" />
              </div>
...
export default {
  ...
  methods: {
    ...
    saveData() {
      ...
      axios.post("http://127.0.0.1:8000/api/staffs", data, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " +store.getters.getAdminToken,
        },
