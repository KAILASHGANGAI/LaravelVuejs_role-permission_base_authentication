<template>
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li v-if="is('Super-Admin')" class="nav-item">
            <router-link class="nav-link collapsed" to="/admin/students" data-toggle="collapse"
        ...
        <li v-if="is('Super-Admin')" class="nav-item">
            <router-link class="nav-link collapsed" to="/admin/staff-details" data-toggle="collapse"
                data-target="#Staff" aria-expanded="true" aria-controls="Staff">
                <i class="fas fa-fw fa-cog"></i>
        ...
        <li v-if="is('Super-Admin')" class="nav-item">
            <router-link class="nav-link collapsed" to="/admin/period-details" data-toggle="collapse"
                data-target="#Class" aria-expanded="true" aria-controls="Class">
                <i class="fas fa-fw fa-cog"></i>
        ...
        <li v-if="is('Super-Admin')" class="nav-item">
            <router-link class="nav-link collapsed" to="/admin/attendance-details" data-toggle="collapse"
        ...
        <li class="nav-item" v-if="is('accountent|Super-Admin')">
            <router-link class="nav-link collapsed" to="/admin/account-details" data-toggle="collapse"
                data-target="#Account" aria-expanded="true" aria-controls="Account">
                <i class="fas fa-fw fa-cog"></i>
                <span>Account</span>
            </router-link>
        ...
        <li v-if="is('Super-Admin')" class="nav-item">
            <router-link class="nav-link collapsed" to="/admin/marksheet-show" data-toggle="collapse"
        ...
        <li v-if="is('Super-Admin')" class="nav-item">
            <router-link class="nav-link collapsed" to="/admin/show-notes" data-toggle="collapse"
